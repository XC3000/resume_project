...
import { Shield, Mail, Lock, User, AlertCircle, ArrowRight, Github } from 'lucide-react';
      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-slate-900/40 border border-slate-800/80 shadow-2xl backdrop-blur-xl relative z-10">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-400 mt-2">
            Get started with AI-driven SRE Copilot
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 rounded-xl bg-slate-950/60 border border-slate-800 focus:border-indigo-500/60 focus:ring-1 focus:ring-indigo-500/30 outline-none text-slate-200 transition"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 mt-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold transition shadow-lg shadow-indigo-500/20 flex items-center justify-center gap-2 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
          >
        ...
        <button
          ...
          className="w-full py-2.5 rounded-xl bg-slate-950 hover:bg-slate-900 border border-slate-800 text-slate-200 transition flex items-center justify-center gap-2"
        >
