    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl glass-panel relative gradient-border">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold tracking-tight gradient-text mb-2">Create Account</h1>
          <p className="text-muted-foreground text-sm">Join Platform Analytics telemetry network</p>
        </div>
